...
/**
 * This is Map detail_rectangle is used to store the detail of every area rectangle.
 * @author Parth B Gadhiya
 */
public class Mapdetail_rectangle extends Rectangle{
    
    public int area_id;
    public char minion[]=null;
    ...
    public int width_rectangle;
    public int height_rectangle;
    public int corner_x=10;
    public int corner_y=10;
    public String area_name;
    public String area_detail;
    public int adjacent[]=null;
    public int area_cost;
    public int[][] line_map = new int[29][4];
