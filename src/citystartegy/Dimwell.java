 ...
 * @author admin
 */
public class Dimwell implements CityInterface{
                ...
                if (money >= cost) {
                    do {
                        try {
                            ...
                            configModel.adjacentarea = configModel.Area_detail_list.get(7).getadjacent();
                            configModel.adjacent_list.add(8);
                            ...
                            Logger.getLogger(Dimwell.class.getName()).log(Level.SEVERE, null, ex);
                        }
